...
frank = User.create({ email: 'frank@xxxx.com', password: 'testtest', password_confirmation: 'testtest', agent: true })
sem = User.create({ email: 'sem@xxxx.com', password: 'testtest', password_confirmation: 'testtest', agent: true })
